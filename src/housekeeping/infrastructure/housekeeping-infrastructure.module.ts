...
import {
  ...
  OPTIONS_TYPE,
} from './housekeeping-infrastructure.module-definition';
...
@Module({})
export class HousekeepingInfrastructureModule extends ConfigurableModuleClass {
  constructor() {
    super();
  }
  static register(options: typeof OPTIONS_TYPE): DynamicModule {
    ...
    return {
      module: HousekeepingInfrastructureModule,
