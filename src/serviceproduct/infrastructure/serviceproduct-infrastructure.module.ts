...
import {
  ...
  OPTIONS_TYPE,
} from './serviceproduct-infrastructure.module-definition';
...
@Module({})
export class ServiceproductInfrastructureModule extends ConfigurableModuleClass {
  constructor() {
    super();
  }
  static register(options: typeof OPTIONS_TYPE): DynamicModule {
    ...
    return {
      module: ServiceproductInfrastructureModule,
