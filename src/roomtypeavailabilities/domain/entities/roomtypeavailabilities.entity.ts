...
export class Roomtypeavailabilities extends Entity {
    ...
    get availableQuantity() { return this._availableQuantity }



    private _priceModifier?: number;

    get priceModifier() { return this._priceModifier }



    private _minStayNights?: number;

    get minStayNights() { return this._minStayNights }



    private _maxStayNights?: number;

    get maxStayNights() { return this._maxStayNights }
