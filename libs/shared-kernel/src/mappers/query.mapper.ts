...
export class QueryMapper {
     ...
     */
    public static toQueryOptions(queryDto?: QueryDto): QueryOptions {
        if (!queryDto) {
            return {};
        }
     ...
     * @returns QueryOptions object for repository use
     */
    static toQueryOptionsWithPopulate(queryDto?: QueryDto, populate?: string[]): QueryOptions {
        const queryOptions = this.toQueryOptions(queryDto);
